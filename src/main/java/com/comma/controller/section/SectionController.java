...
import com.comma.domain.section.*;
import com.comma.domain.user.User;
import com.comma.service.section.*;
...
public class SectionController {
    ...
    public ModelAndView getSection(@PathVariable String url, HttpSession session) {
        ...
        mv.setViewName("section/section");
        return mv;
    }
    ...
    public  ModelAndView getNewPost(@RequestBody Map<String, String> request){
        ...
        mv.setViewName("section/new-post");
        return mv;
    }
    ...
    public ModelAndView getSubsectionsManagement(@RequestBody Map<String, String> request) {
        ...
        mv.setViewName("section/subsections-management");
        return mv;
    }
    ...
    public  ModelAndView getPostDetail(@RequestBody Map<String, String> request){
        ModelAndView mv = new ModelAndView();
        ...
        mv.setViewName("section/post-detail");
        return mv;
    }
